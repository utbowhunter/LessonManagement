...
public class DBAdapter {
	...
	public static final double LESSON_RATE = 0.00;
	...
	+ "firstName VARCHAR not null, lastName VARCHAR not null, preferredName VARCHAR not null, birthDate VARCHAR null, "
	+ "address VARCHAR not null, city VARCHAR not null, state char(2) not null, zip char(10) not null, phone char(14), "
	+ "parentName VARCHAR not null, parentPhone VARCHAR not null, lessonPrice double 0);";
	...
	private static final String APPOINTMENT_TABLE_CREATE = "create table if not exists " + TABLE_APPOINTMENT + " (id integer primary key autoincrement, "
			+ "date DATE not null, startTime TIME not null, endTime TIME not null, status int not null);";
	...
	private static final String PAYMENT_TABLE_CREATE = "create table if not exists " + TABLE_PAYMENT + " (id integer primary key autoincrement, "
			+ "amount REAL not null, type INTEGER not null, date VARCHAR not null, checkNum TEXT null, notes TEXT null);";
